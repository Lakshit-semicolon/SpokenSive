...
def command_line():
    ...
    if not os.path.exists('c:/Users/asus/Desktop/lakshit/Python programs/Hand/images'):
        print('Creating images folder')
        os.makedirs('c:/Users/asus/Desktop/lakshit/Python programs/Hand/images')
    ...
    for index, line in enumerate(text_in):
        ...
        if not line.strip() == '':
            ...
            image_out = os.path.join('c:/Users/asus/Desktop/lakshit/Python programs/Hand/images/', str(index) + '.png')
